...
const OrphanageDetails = () => {
	...
	const routeParams = route.params as {id: number}
	...
	useEffect(()=>{
		...
		})).catch((err)=> alert("Não foi possível conecetar com o servidor!"));

	},[routeParams])

	useEffect(()=>{console.log(JSON.stringify(orphanage))}, [orphanage])
